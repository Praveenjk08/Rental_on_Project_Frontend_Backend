...
VehicleId: <br> <input type="number" placeholder="Enter vehicle id" name="vid" required><br>
...
TotalAmount: <br> <input type="number" placeholder="Total amount" name="am" required="required"><br>
